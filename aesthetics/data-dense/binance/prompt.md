# 数据密集 · Binance 设计系统
> SDesign 去 AI 味设计系统 · 美学来源 open-design(`binance`,Apache-2.0)
> **用法**:把下面 ```text 代码块里的整段**复制**,粘给你的 AI(Claude Code / ChatGPT / Codex / 任意),让它做**网页 / 落地页**(本套 token 是 CSS 单位)。

```text
# 美学:数据密集(Data Dense)— Binance 风格
图表/表格/指标为主 + 紧间距 + 暗色仪表盘;专业、信息高密度。

# 设计 token(必须用这些精确值,不准自创别的颜色)
- 背景:#ffffff
- 表面/卡片:#ffffff ,边框 #e6e8ea
- 正文主色:#1e2026 ;次级:#32313a ;弱化:#848e9c
- 强调色(只此一个):#f0b90b —— 只用在唯一焦点 / 主 CTA / 小标签
- 圆角:卡片 24px,按钮 12px
- 标题字体:BinancePlex, Arial, sans-serif
- 正文字体:BinancePlex, Arial, sans-serif
- 行高:正文 1.5,标题 1.10
